<?php
  ...
  // Init vars
  $name = $email = $password = $confirm_password = $fonction = '';
  $name_err = $email_err = $password_err = $confirm_password_err = $fonction_err= '';
  ...
  if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(empty($name_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)){
      ...
      $sql = 'INSERT INTO users (name, email, password, fonction) VALUES (:name, :email, :password, :fonction)';
      ...
      <div class="col-md-6 mx-auto">
        <div class="card card-body bg-light mt-5">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            ...
            <div class="form-group">
              <label for="confirm_password">Fonction</label>
              <input type="text" name="fonction" class="form-control form-control-lg <?php echo (!empty($fonction_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $fonction; ?>">
              <span class="invalid-feedback"><?php echo $confirm_password_err; ?></span>
            </div>
